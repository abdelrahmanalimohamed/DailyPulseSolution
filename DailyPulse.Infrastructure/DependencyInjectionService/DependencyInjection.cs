...
namespace DailyPulse.Infrastructure.DependencyInjectionService
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services , IConfiguration Configuration)
        {
            ...
            services.AddAuthentication(options =>
            {
              ...
              .AddJwtBearer(options =>
              {
                  ...
                  options.TokenValidationParameters = new TokenValidationParameters
                  {
                      ...
                      ValidIssuer = "https://localhost:7114/", // Replace with your domain
            ...
            services.AddSingleton<ITokenGenerator>(new JwtTokenGenerator("", "https://localhost:7114/s"));
            return services;
        }
    }
}